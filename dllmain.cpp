...
auto EndScene(ImGuiWindow& window) -> void
{
	...
	{
		if (ImGui::Begin("Ceylin Rogue Company", nullptr, WindowFlags))
		{
			...
			case 0:
				...
				if (!strcmp(SelectedAimType, "MEMORY")) Settings::bMemoryAimbot = true;


				ImGui::NewLine();
				ImGui::Checkbox("Memory Aimbot", &Settings::bSkipTargetsOutOfBounds);
